		...
		<table class="table" border="2" width="100%">
			<tr>
				<td width="70%">
					...
					<tr>
						<td>
							Total Paid: <?php echo $advertise->cost;?>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							...
							<table width="100%" border="2">
								...
								<tr>
									<td><?php echo date('m-d-Y', strtotime($advertise->duration_from)) ;?></td>
									<td><?php echo date('m-d-Y', strtotime($advertise->duration_to));?></td>
									<td>2017</td>
									<td>12</td>
								</tr>
							</table>
				...
				<td width="30%">
					...
					<center><h4>
						RECEIPT NUMBER
						<br>
						A : <?php echo $advertise->id;?>
					</h4></center>
					<hr>
					<center><h4>
						Date
						<br>
						 <?php echo date('m-d-Y', strtotime($advertise->created));?>
					</h4></center>
					<hr>
					<center><h4>
						Amount
						<br>
						 <?php echo $advertise->cost;?>
					</h4></center>
					<hr>
					<center><h4>
...
<input type="hidden" name="receipt_id" id="receipt_id" value="<?php echo $advertise->id;?>">
...
function downloadReceipt()
{
	...
	{
		method: 	"POST",
	 	url: 		"<?php echo site_url();?>/ajax/downloadAddreceipt/"+id, 
	 	dataType: 	'JSON',
